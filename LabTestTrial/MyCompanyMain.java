...
public class MyCompanyMain{
	public static void main (String[] args){
		...
		System.out.println(comp_Address.getNoShop() + " : " + comp_Address.getRoad() + " : " + comp_Address.getDistrict() + " : " + comp_Address.getPhone());
		
		for (Supplier s : company.getSuppliers()){
			System.out.print(s.getSupplierName() + " \t: ");
			Address supp_Address = s.getAddress();
			
			System.out.println(supp_Address.getNoShop() + " : " + supp_Address.getRoad() + " : " + supp_Address.getDistrict() + " : " + supp_Address.getPhone());
